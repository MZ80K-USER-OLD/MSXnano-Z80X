            ...
            IF code_ready = '1' THEN
                ...
                ELSE
                    ...
                    CASE scan_code IS
                        ...
                        -- =====================================================
                        -- 行 1 (数値キー、記号等) - US配列版を優先
                        -- =====================================================
                        WHEN X"3E" => keys(1)(0) <= key_val; -- '8'
                        WHEN X"46" => keys(1)(1) <= key_val; -- '9'
                        WHEN X"4E" => keys(1)(2) <= key_val; -- '-'
                        WHEN X"55" => keys(1)(3) <= key_val; -- '='
                        WHEN X"5D" => keys(1)(4) <= key_val; -- '\'
                        WHEN X"54" => keys(1)(5) <= key_val; -- '['
                        WHEN X"5B" => keys(1)(6) <= key_val; -- ']'
                        WHEN X"4C" => keys(1)(7) <= key_val; -- ';'

                        -- =====================================================
                        -- 行 2 / 3 / 4 / 5 (アルファベット + US記号補助)
                        -- =====================================================
                        WHEN X"0E" => keys(2)(1) <= key_val; -- '`' / '~'
                        WHEN X"52" => keys(2)(0) <= key_val; -- '''
                        WHEN X"41" => keys(2)(2) <= key_val; -- ','
                        WHEN X"49" => keys(2)(3) <= key_val; -- '.'
                        WHEN X"4A" => keys(2)(4) <= key_val; -- '/'
                        ...
                        -- US配列版では上記の行 1 / 行 2 の定義を優先し、重複マッピングは削除.
